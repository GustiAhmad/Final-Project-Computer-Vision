...
│   ├── deteksi_keypoint.py # Deteksi awal untuk keypoint
...
Pastikan file gambar Anda sudah berada di folder dataset/.

Untuk melihat hasil pencocokan fitur (garis penghubung):

python src/cek_kecocokan.py


Untuk menghasilkan citra panorama utuh:

python src/buat_panorama.py
...
Visualisasi Matching: Menampilkan garis-garis yang menghubungkan titik identik antara dua foto.

Hasil Panorama: Satu gambar lebar yang menyatukan kedua sisi bangunan posko tanpa adanya patahan struktur.

🔄 Alur Kerja Sistem

Preprocessing: Mengubah citra ke grayscale.

Ekstraksi Fitur: Mendeteksi keypoints dan menghitung descriptors dengan SIFT.

Matching: Mencari pasangan titik yang mirip antar citra.

Homografi: Menghitung matriks transformasi koordinat menggunakan RANSAC.

Warping & Merging: Melenturkan citra dan menempelkannya ke kanvas utama.
...
Proyek ini dikembangkan untuk tujuan edukasi dan pemahaman algoritma ekstraksi fitur lokal.